            ...
            <div className="product-item-cart-wrapper">
              ...
              <div className="each-cart-item">
                <div className="cart-image-wrapper">
                  <img
                    src="https://ng.jumia.is/unsafe/fit-in/150x150/filters:fill(white)/product/64/629476/1.jpg?5803"
                    alt=""
                  />
                </div>
                <div className="each-item-details">
                  <div>
                    <p>
                      Trendyol Collection Gray Men's Oversize Crew Neck Short
                      Sleeve{" "}
                    </p>
                  ...
                  <div className="price-discount-wrapper">
                    <div className="price-wrapper-dicount-cart">
                      <p>
                        <TbCurrencyNaira className="product-price-icon-discount" />
                      </p>
                      <p className="product-current-price-cart">5,000</p>
                    </div>
