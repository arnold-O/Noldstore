        ...
        <div className="headerWrapper">
          <div className="headerWrapper-first">
            <div className="category-section-left">
              <div className="category-filter-section">
                ...
                <Link className="links" to="fashion">
                  Fashion
                </Link>
              </div>
              <div className="category-filter-section">
                <GiConverseShoe className="header-icon" />
                <Link className="links" to="shoes">
                  Shoes
                </Link>
              </div>
              <div className="category-filter-section">
              ...
              <div className="category-filter-section">
                ...
                <Link className="links" to="headphones">
                  Head Phones
                </Link>
              </div>
              <div className="category-filter-section">
          ...
          <div>
            <div className="header-image-container">
              <img
                src="https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTd8fGVjb21tZXJjZXxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60"
                alt=""
              />
            </div>
          </div>
